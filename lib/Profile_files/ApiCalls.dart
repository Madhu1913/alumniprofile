...
String placement_api =
    "https://apps.technicalhub.io/old/techpanel2/api/asp_placements_data/?id=16A91A0222";
String currentCompany_api =
    "https://apps.technicalhub.io/old/techpanel2/api/asp_placements_data/get.php?id=16A91A0222";
...
Get_placement(String UID) async {
  ...
  await http
      .get(Uri.parse(
          "https://apps.technicalhub.io/old/techpanel2/api/asp_placements_data/?id=$UID"))
      .then((res) {
...
UpdateCompany(String UID, String companyName, String companyLocation) async {
  print("HI");
  await http
      .post(Uri.parse(
          "https://apps.technicalhub.io/old/techpanel2/api/asp_placements_data/post.php?roll_number=$UID&company_name=$companyName&company_location=$companyLocation"))
      .then((res) {
    if (res.statusCode == 200) {
      print("Updated broo");
